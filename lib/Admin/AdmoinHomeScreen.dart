                    ...
                    child: Center(
                      child: ElevatedButton(
                        ...
                        style: ElevatedButton.styleFrom(
                          ...
                          fixedSize:
                              const Size(200, 50), // Set background color
                        ),
                        child: Text(
                          ' Track Bus',
                          style: TextStyle(
                  ...
                  Positioned(
                    ...
                    child: Center(
                      child: Container(
                        ...
                        height: 410, // Set the height of the second container
                        decoration: BoxDecoration(
    ...
    Container(
      ...
      child: Stack(
        children: <Widget>[
          ...
          const Positioned(
            top: 170, // Adjusted position to be below the CircularProgressIndicator
            left: 0,
            right: 0,
            child: Center(
              child: Text(
          ...
          Positioned(
            top: 230, // Adjusted position to be below the text
            left: 10,
            right: 10,
            child: Row(
